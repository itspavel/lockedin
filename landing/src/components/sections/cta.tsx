export function Cta() {
  return (
    <section id="download" className="grid-bg border-b border-[var(--color-line)] px-6 py-24 text-center sm:py-[100px]"
      ...
      <a href="/download" className="inline-block rounded-[9px] bg-[var(--color-green)] px-7 py-3.5 text-base font-semibold text-[var(--color-on-green)] transition-colors hover:bg-[var(--color-green-hi)]">install lockedin — free in beta</a>
