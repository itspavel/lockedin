    ...
    <section id="pricing" className="border-b border-[var(--color-line)] px-6 py-20 sm:px-12">
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {/* Beta */}
          <div className="rounded-2xl border border-[var(--color-green)] bg-[var(--color-green)]/[0.05] p-8 sm:p-[34px]">
            ...
            <a href="#download" className="block rounded-[9px] bg-[var(--color-green)] py-3 text-center text-sm font-semibold text-[var(--color-on-green)] transition-colors hover:bg-[var(--color-green-hi)]">install lockedin</a>
          </div>
          {/* Pro */}
          <div className="rounded-2xl border border-[var(--color-line)] bg-[var(--color-panel)] p-8 sm:p-[34px]">
            ...
            <a href="#" className="block rounded-[9px] border border-[#2a333f] py-3 text-center text-sm font-semibold text-[var(--color-dim)] transition-colors hover:border-[var(--color-dim)] hover:text-[var(--color-ink)]">join the waitlist</a>
          </div>
        </div>
      </div>
    </section>
